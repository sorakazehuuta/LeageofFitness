...
namespace VitDeck.Validator.RuleSets
{
    ...
    /// 標準ブース
    /// </summary>
    public class Vket2023WinterConceptWorldRuleSet : VketUdonRuleSetBase
    {
        public Vket2023WinterConceptWorldRuleSet() : base(new Vket2023WinterOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2023Winter - Default";
