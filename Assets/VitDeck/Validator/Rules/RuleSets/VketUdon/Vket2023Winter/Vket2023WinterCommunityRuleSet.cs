...
namespace VitDeck.Validator.RuleSets
{
    ...
    /// </summary>
    public class Vket2023WinterCommunityRuleSet : VketUdonRuleSetBase
    {
        public Vket2023WinterCommunityRuleSet() : base(new Vket2023WinterOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2023Winter - Community";
