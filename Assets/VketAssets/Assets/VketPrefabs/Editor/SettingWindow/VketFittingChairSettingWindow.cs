...
{
    public class VketFittingChairSettingWindow : VketPrefabSettingWindow
    {
        #region 設定用変数
        ...
        private void OnGUI()
        {
            ...
            if(!BaseHeader("VketFittingChair"))
                return;
            
            _scrollPosition = EditorGUILayout.BeginScrollView(_scrollPosition, GUI.skin.box);

            /* "1.見た目にする3Dモデルの設定" */
            EditorGUILayout.LabelField(LocalizedMessage.Get("VketFittingChairSettingWindow.VisualSetting"), _settingItemStyle);
            ...
            EditorGUILayout.HelpBox(LocalizedMessage.Get("VketFittingChairSettingWindow.VisualSetting.Help"), MessageType.Info);

            GUILayout.Space(3);

            /* "2.見た目となる3DオブジェクトからColliderを削除" */
            EditorGUILayout.LabelField(LocalizedMessage.Get("VketFittingChairSettingWindow.VisualColliderDeleteButton"), _settingItemStyle);
            ...
            EditorGUILayout.HelpBox(LocalizedMessage.Get("VketFittingChairSettingWindow.VisualColliderDeleteButton.Help"), MessageType.Warning);

            GUILayout.Space(3);

            /* "3.座る位置の調整" */
            EditorGUILayout.LabelField(LocalizedMessage.Get("VketFittingChairSettingWindow.EnterLocationSetting"), _settingItemStyle);
            EditorGUI.BeginChangeCheck();
            ...
            if (GUILayout.Button(LocalizedMessage.Get("VketFittingChairSettingWindow.SelectEnterLocationButton")))
            {
            ...
            EditorGUILayout.HelpBox(LocalizedMessage.Get("VketFittingChairSettingWindow.SelectEnterLocationButton.Help"), MessageType.Info);

            GUILayout.Space(3);
            
            EditorGUILayout.EndScrollView();
            
            BaseFooter("VketFittingChair", _interactObject);
        }
