...
namespace VitDeck.Validator.RuleSets
{
    ...
    /// クエストブース
    /// </summary>
    public class Vket2023WinterQuestRuleSet : VketUdonRuleSetBase
    {
        public Vket2023WinterQuestRuleSet() : base(new Vket2023WinterOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2023Winter - Quest";
        ...
        public override IRule[] GetRules()
        {
            ...
            rules.Add(new TextureLimitRule(LocalizedMessage.Get("TextureLimitRule.Title"), _officialAssetData.GUIDs, null, 2048 * 2048));
            rules.Add(new QuestTextureCompressionRule(LocalizedMessage.Get("QuestTextureCompressionRule.Title"), targetFinder));
        ...
        public virtual Dictionary<string, string> GetAllowedShaders2()
            => new Dictionary<string, string>() { 
                //VketVideoPlayerのシェーダーは許可
                {"Video/RealtimeEmissiveGamma", "9788d723ed7eac946a9a599e4a6ba940"},  // Packages/com.vrchat.base/Runtime/VRCSDK/Sample Assets/Shaders/Video-RealtimeEmissiveGamma.shader
