...
namespace VitDeck.Validator.RuleSets
{
    ...
    /// 大型ブース
    /// </summary>
    public class Vket2023WinterFallenEdenRuleSet : VketUdonRuleSetBase
    {
        public Vket2023WinterFallenEdenRuleSet() : base(new Vket2023WinterOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2023Winter - Fallen Eden";
