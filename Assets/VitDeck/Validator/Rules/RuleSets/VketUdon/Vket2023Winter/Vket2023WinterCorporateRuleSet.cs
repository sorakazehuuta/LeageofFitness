...
namespace VitDeck.Validator.RuleSets
{
    ...
    /// 企業ブース
    /// </summary>
    public class Vket2023WinterCorporateRuleSet : VketUdonRuleSetBase
    {
        public Vket2023WinterCorporateRuleSet() : base(new Vket2023WinterOfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket2023Winter - Corporate";
